...
public class AFND implements Cloneable, Proceso {
    ...
    public String toString() {
        ...
        mensaje.append("\nESTADO INICIAL: ").append(this.estadoInicial);
        mensaje.append("\nESTADOS FINALES: ");
    ...
    public Object clone() {
        ...
        copia.estadosFinales.addAll(this.estadosFinales);

        copia.transiciones = new HashSet<TransicionAFND>();
        copia.transiciones.addAll(this.transiciones);

        copia.transicionesL = new HashSet<TransicionL>();
        copia.transicionesL.addAll(this.transicionesL);
