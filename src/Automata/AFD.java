...
public class AFD implements Cloneable, Proceso {
    ...
    public String toString() {
        ...
        mensaje.append("ESTADO INICIAL: ").append(this.estadoInicial).append("\n");
        mensaje.append("ESTADOS FINALES: \n");
    ...
    /**
     * Simula un AFD, con estados, transiciones, estados finales e inicial, con una cadena para reconcoer a manera de prueba
     *
     * @param args
     */
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        for (String estado : this.estadosFinales) {
            copia.estadosFinales.add(estado); // Se inicializa un nuevo HashSet para estadosFinales en la copia. Luego, se agrega cada estado de this.estadosFinales al nuevo conjunto. Esto asegura que copia.estadosFinales contenga nuevas referencias a los mismos objetos, evitando que ambos objetos compartan la misma referencia.
        }

        copia.transiciones = new HashSet<TransicionAFD>();
        for (TransicionAFD t : this.transiciones) {
            copia.transiciones.add(t); //Finalmente, se retorna la copia del objeto AFD.
        }
